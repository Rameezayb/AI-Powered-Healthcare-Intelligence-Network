...
st.set_page_config(layout='wide', page_title='MedAI Health Assistant - Heart Health Assessment', page_icon=icon)
st.sidebar.markdown("<h2 style='color: #ffffff;'>📌  Description</h2>", unsafe_allow_html=True)
st.sidebar.image("https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80", use_container_width=True)
...
with row6_1:
    st.write("#### Learn More")
    st.markdown("[![](https://img.shields.io/badge/GitHub%20-Features%20Information-informational)](https://github.com/Rameezayb/AI-Powered-Healthcare-Intelligence-Network/tree/main/heart_disease_risk_assessment)")
...
with row10_1:
    st.write("""
        ### Contacts
        [![](https://img.shields.io/badge/GitHub-Follow-informational)](https://github.com/Rameezayb)
        [![](https://img.shields.io/badge/Linkedin-Connect-informational)](https://www.linkedin.com/in/muhammad-rameez-b4751928a)
    """)