...
st.set_page_config(page_title="MedAI Health Assistant - Disease Prediction", page_icon="🏥", layout='wide')
...
st.sidebar.markdown("<p class='sidebar-text'>MedAI's Advanced Disease Prediction system uses cutting-edge AI to analyze symptoms, predict potential health conditions, assess risks, and provide personalized medical recommendations for better healthcare outcomes.</p>", unsafe_allow_html=True)
