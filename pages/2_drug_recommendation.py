...
st.set_page_config(page_title="MedAI Health Assistant - Drug Recommendation", page_icon="🏥", layout='wide')

st.sidebar.markdown("<h2 style='color: #ffffff;'>📌  Description</h2>", unsafe_allow_html=True)
st.sidebar.image("https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80", use_container_width=True)
st.sidebar.markdown("<p class='sidebar-text'>MedAI's Smart Drug Recommendation System uses advanced NLP and cosine similarity algorithms to analyze medications and recommend the most relevant alternatives, ensuring safe, accurate, and personalized treatment options.</p>", unsafe_allow_html=True)
...
st.markdown("""
    <hr>
    <p style='text-align: center; color: #7f8c8d;'>Made by <span style='color: orange'>Muhammad Rameez</span> | 
